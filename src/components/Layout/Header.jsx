  ...
  return (
    <>
      ...
      >
        ...
        {open && (
          <div
            className={`fixed w-full h-full top-0 left-0 bg-[#0000005f] z-10`}
          >
            <div className="fixed w-[70%] bg-[#fff] h-screen top-0 left-0 z-20 overflow-y-scroll">
              ...
              <div className="my-8 w-[92%] m-auto h-[40px]">
                ...
                />
                {searchData && (
                  <div className="absolute bg-[#fff] z-20 shadow w-full left-0 p-3">
                    {searchData.map((i) => {
                      const d = i.name;
                      const Product_name = d.replace(/\s+/g, "-");
                      return (
